...
import { Upload, Image as ImageIcon, FileText, Coins, Sparkles, X, Check } from 'lucide-react'
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-dark-300 text-lg max-w-2xl mx-auto">
            Upload your artwork, add metadata, and mint your unique digital asset on the blockchain
          </p>
        </motion.div>
            ...
            <div className="card">
              ...
              {!nftData.imagePreview ? (
                ...
                >
                  ...
                  <p className="text-dark-300 mb-2">Drag and drop your image here</p>
                ...
                <div className="relative">
                  ...
                  />
                  <button
                    onClick={() => setNftData(prev => ({ ...prev, image: null, imagePreview: '' }))}
